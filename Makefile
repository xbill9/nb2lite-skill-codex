...
help:
	...
	@echo "  make skill-install - Refresh + copy the skill to ~/.agents/skills (all projects)"
...
# Lint the repo-root sources (mcp/, .agents/skills/ and skills/ hold generated
...
# files can never enter the build context). Bump VERSION with .codex-plugin/plugin.json.
docker-build:
