...
Regenerates:
  ...
  .agents/skills/nb2lite-image/        assembled from SKILL.md + mcp/ + references/
...
SKILL = ROOT / ".agents" / "skills" / "nb2lite-image"
...
def main() -> int:
    ...
    shutil.copyfile(ROOT / "agents" / "openai.yaml", SKILL / "agents" / "openai.yaml")
